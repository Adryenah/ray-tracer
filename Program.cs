    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var geometries = new Geometry[]
            {
                ...
                new RawCtMask("C:\\Users\\georg\\OneDrive\\Desktop\\VRan3\\VirtualRealitiLab1\\walnut.dat", "C:\\Users\\georg\\OneDrive\\Desktop\\VRan3\\VirtualRealitiLab1\\walnut.raw", new Vector(-5.0, -20.0, 105.0), 0.15,
                    new ColorMap()
            ...
            var middle = new Vector(15.0, -5.0, 115.0);
            var up = new Vector(1, 0, 0).Normalize();
